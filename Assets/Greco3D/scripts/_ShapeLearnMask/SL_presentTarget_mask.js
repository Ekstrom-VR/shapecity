...
var rect2 =Rect((Screen.width / 2),(Screen.height/10),buttonWidth,buttonHeight);
		...
		if(t_load == null){
		t_load = new WWW(SL_getShapes_mask.protoPath);  
		print(SL_getShapes_mask.protoPath);
		...
		GUI.Label(rect1,SL_task_mask.curShapeName,style1);
...
SL_task_mask.task_stage = "Test";
print('stage num:' + SL_task_mask.stageNum);
this.enabled = false;
}  	
