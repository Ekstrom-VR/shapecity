...
function OnGUI(){
		...
		var rect1 =Rect((Screen.width / 2) - (buttonWidth / 2),(Screen.height/3),buttonWidth,buttonHeight);
	    var rect2 =Rect((Screen.width / 2) -  (buttonWidth / 2),(Screen.height/2) ,buttonWidth,buttonHeight);
