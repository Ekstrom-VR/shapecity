...
function OnGUI(){
	...
	//Print performance
	var perf =  SL_test_morph.numCorrect / (SL_task_morph.numTrials - 1) * 100;
...
SL_task_morph.task_stage = "PreTest";
}
else { 
SL_task_morph.task_stage = "End";
